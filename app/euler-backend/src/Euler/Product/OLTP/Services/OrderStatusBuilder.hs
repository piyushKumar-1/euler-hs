...
buildOrderStatusResponse OrderStatusResponseCollector{..} = D.OrderStatusResponse
  ...
  , payment_links             = fmap getLast payment_linksT
  , udf                       = fmap getLast udfT
  , txn_id                    = fmap getLast txn_idT
  , status_id                 = fmap getLast status_idT
  , status                    = fmap getLast statusT
