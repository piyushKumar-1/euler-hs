...
rr5 :: ResultRecording
rr5 = fromJust $ decode $ "{\"recording\":[{\"_entryName\":\"PSubscribeEntry\",\"_entryIndex\":0,\"_entryPayload\":{\"jsonPatterns\":[{\"utf8\":\"?test\",\"b64\":\"P3Rlc3Q=\"}]},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":1,\"_entryPayload\":{\"jsonResult\":[]},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":2,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"ptest\",\"b64\":\"cHRlc3Q=\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests\",\"b64\":\"SGVsbG8sIFRlc3Rz\"},\"jsonResult\":{\"Right\":1}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":3,\"_entryPayload\":{\"jsonResult\":null},\"_entryReplayMode\":\"Normal\"}],\"forkedRecordings\":{}}"

-- Callback receive messages from all subscribed channels
rr6 :: ResultRecording
rr6 = fromJust $ decode $ "{\"recording\":[{\"_entryName\":\"SubscribeEntry\",\"_entryIndex\":0,\"_entryPayload\":{\"jsonChannels\":[{\"utf8\":\"test_0\",\"b64\":\"dGVzdF8w\"},{\"utf8\":\"test_1\",\"b64\":\"dGVzdF8x\"}]},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":1,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"test_0\",\"b64\":\"dGVzdF8w\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests_0\",\"b64\":\"SGVsbG8sIFRlc3RzXzA=\"},\"jsonResult\":{\"Right\":1}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":2,\"_entryPayload\":{\"jsonResult\":{\"utf8\":\"Hello, Tests_0\",\"b64\":\"SGVsbG8sIFRlc3RzXzA=\"}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":3,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"test_1\",\"b64\":\"dGVzdF8x\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests_1\",\"b64\":\"SGVsbG8sIFRlc3RzXzE=\"},\"jsonResult\":{\"Right\":1}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":4,\"_entryPayload\":{\"jsonResult\":{\"utf8\":\"Hello, Tests_1\",\"b64\":\"SGVsbG8sIFRlc3RzXzE=\"}},\"_entryReplayMode\":\"Normal\"}],\"forkedRecordings\":{}}"

-- Unsubscribe unsubscribes from all subscribed channels
rr7 :: ResultRecording
rr7 = fromJust $ decode $ "{\"recording\":[{\"_entryName\":\"SubscribeEntry\",\"_entryIndex\":0,\"_entryPayload\":{\"jsonChannels\":[{\"utf8\":\"test_0\",\"b64\":\"dGVzdF8w\"},{\"utf8\":\"test_1\",\"b64\":\"dGVzdF8x\"}]},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":1,\"_entryPayload\":{\"jsonResult\":[]},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":2,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"test_0\",\"b64\":\"dGVzdF8w\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests_0\",\"b64\":\"SGVsbG8sIFRlc3RzXzA=\"},\"jsonResult\":{\"Right\":1}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":3,\"_entryPayload\":{\"jsonResult\":null},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":4,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"test_1\",\"b64\":\"dGVzdF8x\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests_1\",\"b64\":\"SGVsbG8sIFRlc3RzXzE=\"},\"jsonResult\":{\"Right\":0}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":5,\"_entryPayload\":{\"jsonResult\":null},\"_entryReplayMode\":\"Normal\"}],\"forkedRecordings\":{}}"
