...
rr2 :: ResultRecording
rr2 = fromJust $ decode $ "{\"recording\":[{\"_entryName\":\"GenerateGUIDEntry\",\"_entryIndex\":0,\"_entryPayload\":{\"guid\":\"eea19875-6043-4867-b27c-4ac52a89f8fe\"},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"LogMessageEntry\",\"_entryIndex\":1,\"_entryPayload\":{\"tag\":\"\\\"ForkFlow\\\"\",\"msg\":\"Flow forked. Description: Fork GUID: eea19875-6043-4867-b27c-4ac52a89f8fe\",\"level\":\"Info\"},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"ForkEntry\",\"_entryIndex\":2,\"_entryPayload\":{\"guid\":\"eea19875-6043-4867-b27c-4ac52a89f8fe\",\"description\":\"Fork\"},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":3,\"_entryPayload\":{\"jsonResult\":[],\"description\":\"\"},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":4,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"test\",\"b64\":\"dGVzdA==\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests\",\"b64\":\"SGVsbG8sIFRlc3Rz\"},\"jsonResult\":{\"Right\":1}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":5,\"_entryPayload\":{\"jsonResult\":{\"utf8\":\"Hello, Tests\",\"b64\":\"SGVsbG8sIFRlc3Rz\"},\"description\":\"\"},\"_entryReplayMode\":\"Normal\"}],\"forkedRecordings\":{\"eea19875-6043-4867-b27c-4ac52a89f8fe\":{\"recording\":[{\"_entryName\":\"GenerateGUIDEntry\",\"_entryIndex\":0,\"_entryPayload\":{\"guid\":\"bbfa3326-ec02-47f4-a678-24525309ad9c\"},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunSafeFlowEntry\",\"_entryIndex\":1,\"_entryPayload\":{\"jsonResult\":{\"Right\":[]},\"guid\":\"bbfa3326-ec02-47f4-a678-24525309ad9c\"},\"_entryReplayMode\":\"Normal\"}],\"forkedRecordings\":{},\"safeRecordings\":{\"bbfa3326-ec02-47f4-a678-24525309ad9c\":{\"recording\":[{\"_entryName\":\"SubscribeEntry\",\"_entryIndex\":0,\"_entryPayload\":{\"jsonChannels\":[{\"utf8\":\"test\",\"b64\":\"dGVzdA==\"}]},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":1,\"_entryPayload\":{\"jsonResult\":[],\"description\":\"\"},\"_entryReplayMode\":\"Normal\"}],\"forkedRecordings\":{},\"safeRecordings\":{}}}}},\"safeRecordings\":{}}"


-- Callback does not receive messages from channel after unsubscribe (subscribe method)
rr3 :: ResultRecording
rr3 = fromJust $ decode $ "{\"recording\":[{\"_entryName\":\"SubscribeEntry\",\"_entryIndex\":0,\"_entryPayload\":{\"jsonChannels\":[{\"utf8\":\"test\",\"b64\":\"dGVzdA==\"}]},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":1,\"_entryPayload\":{\"jsonResult\":[],\"description\":\"subscribe\"},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":2,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"test\",\"b64\":\"dGVzdA==\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests\",\"b64\":\"SGVsbG8sIFRlc3Rz\"},\"jsonResult\":{\"Right\":1}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":3,\"_entryPayload\":{\"jsonResult\":null,\"description\":\"\"},\"_entryReplayMode\":\"Normal\"}],\"forkedRecordings\":{},\"safeRecordings\":{}}"
...
rr5 :: ResultRecording
rr5 = fromJust $ decode $ "{\"recording\":[{\"_entryName\":\"PSubscribeEntry\",\"_entryIndex\":0,\"_entryPayload\":{\"jsonPatterns\":[{\"utf8\":\"?test\",\"b64\":\"P3Rlc3Q=\"}]},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":1,\"_entryPayload\":{\"jsonResult\":[],\"description\":\"psubscribe\"},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":2,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"ptest\",\"b64\":\"cHRlc3Q=\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests\",\"b64\":\"SGVsbG8sIFRlc3Rz\"},\"jsonResult\":{\"Right\":1}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":3,\"_entryPayload\":{\"jsonResult\":null,\"description\":\"\"},\"_entryReplayMode\":\"Normal\"}],\"forkedRecordings\":{},\"safeRecordings\":{}}"
...
rr7 :: ResultRecording
rr7 = fromJust $ decode $ "{\"recording\":[{\"_entryName\":\"SubscribeEntry\",\"_entryIndex\":0,\"_entryPayload\":{\"jsonChannels\":[{\"utf8\":\"test_0\",\"b64\":\"dGVzdF8w\"},{\"utf8\":\"test_1\",\"b64\":\"dGVzdF8x\"}]},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":1,\"_entryPayload\":{\"jsonResult\":[],\"description\":\"subscribe\"},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":2,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"test_0\",\"b64\":\"dGVzdF8w\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests_0\",\"b64\":\"SGVsbG8sIFRlc3RzXzA=\"},\"jsonResult\":{\"Right\":1}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":3,\"_entryPayload\":{\"jsonResult\":null,\"description\":\"\"},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"PublishEntry\",\"_entryIndex\":4,\"_entryPayload\":{\"jsonChannel\":{\"utf8\":\"test_1\",\"b64\":\"dGVzdF8x\"},\"jsonPayload\":{\"utf8\":\"Hello, Tests_1\",\"b64\":\"SGVsbG8sIFRlc3RzXzE=\"},\"jsonResult\":{\"Right\":0}},\"_entryReplayMode\":\"Normal\"},{\"_entryName\":\"RunIOEntry\",\"_entryIndex\":5,\"_entryPayload\":{\"jsonResult\":null,\"description\":\"\"},\"_entryReplayMode\":\"Normal\"}],\"forkedRecordings\":{},\"safeRecordings\":{}}"
